...
import com.chunaixxx.myapplication.Color.ColorData
import com.chunaixxx.myapplication.R
import com.chunaixxx.myapplication.databinding.ActivityAddEditBinding
import com.chunaixxx.myapplication.helpers.DateHelper
    ...
    private fun setActionBar() {
        if (flag == 0) {
            supportActionBar!!.title =
                Html.fromHtml("<font color=\"#FFFFFF\">" + "Добавить заметку" + "</font>", 0)
        } else {
            supportActionBar!!.title =
                Html.fromHtml("<font color=\"#FFFFFF\">" + "Удалить заметку" + "</font>", 0)
        }
        ...
        when(item.itemId){
            R.id.action_delete_note -> {
               MaterialAlertDialogBuilder(this)
                   ...
                   .setMessage("Вы действительно хотите удалить замтеку?")
            ...
            R.id.action_pick_color -> {
                ...
                builder.setTitle("Изменение цвета заметки")
